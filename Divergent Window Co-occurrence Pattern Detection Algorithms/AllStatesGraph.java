...
public class AllStatesGraph {
	...
	public AllStatesGraph( int dimNum)
	{
	...
	public void preprocessTimeSeriesIntoStateGraphs(EngineReading[] allReadings)
	{
	...
	//overloaded method for CO2
	public void preprocessTimeSeriesIntoStateGraphs(EngineReadingCO2[] allReadings)
	{
		for(int i=0, j=i+1;j<allReadings.length;i++,j++) //pass by every two consecutive readings
		{
			for(int d = 0;d<dimensionsNum;d++) //pass by all dimensions for those readings
	...
	public int[] countPatternUsingStateGraphs(EngineReading[] allReadings, LinkedHashMap<String, TemporalWindow> anomalousWindows, ArrayList<Integer> includedDimensions, int windowFrom, int windowTo, int from, int to, int lag)
	{
	...
	//overloaded method for CO2 case study
	public int[] countPatternUsingStateGraphs(EngineReadingCO2[] allReadings, LinkedHashMap<String, TemporalWindow> anomalousWindows, ArrayList<Integer> includedDimensions, int windowFrom, int windowTo, int from, int to, int lag)
	{
		//returns an integer array of length 3. 
		//First integer is count of pattern
		//Second integer is count of pattern with anomaly
